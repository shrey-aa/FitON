...
const About = ( {navigation }) => {
  ...
  if (isRegisted) {
    ...
    <View style={styles.container}>
       <Text style={styles.showCaseText}>Welcome</Text>
      <View style={styles.showCase}>
       
      <Text style={styles.showCaseText}>Thank You For Using "Aarogyam" Fitness App</Text>
      <Text style={styles.showCaseText}>Made By Shreya,
       </Text>
  ...
  return (
    ...
    <View style={styles.container}>
        <View>
            <Text style = {styles.heading}>FitON  🚴‍♂️</Text>
            <Text>  </Text>
            <Text style={styles.showCase}></Text>
            <Text>  </Text>
        </View>
      <TextInput
        style={styles.input}
